type SfxName = "bomb" | "explode" | "pickup" | "die" | "win" | "lose" | "thunder" | "laser";
  ...
  play(name: SfxName) {
    try {
      switch (name) {
        ...
        case "explode":
          beep(120, 0.16, "triangle", 0.20, 72);
          setTimeout(() => beep(62, 0.28, "sine", 0.13, 38), 55);
          break;
        ...
        case "laser": beep(880, 0.18, "sawtooth", 0.15, 220); break;
        case "thunder":
          // 低频轰鸣 + 快速衰减，模拟雷声
